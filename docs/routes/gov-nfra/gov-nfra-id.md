...
## Route
- Namespace: `gov/nfra`
- Namespace Name: `国家金融监督管理总局`
- Route Path: `/gov/nfra/:id?`
- Route Name: `分类`
...
## Parameters
- `id`: 分类，默认为监管动态，即 915，可在对应分类页 URL 中找到
...
- `title`: `首页 - 弹出公告`
- `source`:
  - `www.nfra.gov.cn/cn/view/pages/ItemList.html`
- `target`: `/972`
### Rule 2
- `title`: `首页 - 法律声明`
- `source`:
...
- `title`: `政务信息 - 政府信息公开`
- `source`:
  - `www.nfra.gov.cn/cn/view/pages/zhengwuxinxi/zhengfuxinxi.html`
- `target`: `/924`
### Rule 15
- `title`: `政务信息 - 公告通知`
- `source`:
