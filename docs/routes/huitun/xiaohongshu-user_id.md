...
- Namespace: `huitun`
- Namespace Name: `灰豚数据`
- Route Path: `/xiaohongshu/:user_id`
- Route Name: `小红书笔记`
...
- Source Module: `() => import('@/routes/huitun/xiaohongshu.ts')`

## Description
免费版账户每天查询次数为10次, 若需增加查询次数请购买灰豚数据红薯版会员
...
```json
{
  ...
  "module": "() => import('@/routes/huitun/xiaohongshu.ts')",
  "name": "小红书笔记",
  "parameters": {
    "user_id": "小红书用户号，需登录小红书网页端查询"
  },
