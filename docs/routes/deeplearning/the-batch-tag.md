...
- Namespace Name: `DeepLearning.AI`
- Route Path: `/the-batch/:tag{.+}?`
- Route Name: `The Batch`
- Example: `/deeplearning/the-batch`
- URL: `www.deeplearning.ai`
- Language: `en`
- Categories: `programming`
- Maintainers: `nczitzk, juvenn, TonyRL`
- Source Location: `the-batch.ts`
- Source Module: `() => import('@/routes/deeplearning/the-batch.ts')`
...
```json
{
  ...
  "module": "() => import('@/routes/deeplearning/the-batch.ts')",
  "name": "The Batch",
  "parameters": {
    "tag": "Tag, Weekly Issues by default"
  },
