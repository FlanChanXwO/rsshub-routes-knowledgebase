...
- Route Path: `/submission-comments/:id`
...
- Source Module: `() => import('@/routes/furaffinity/submission-comments.ts')`
...
```json
{
  ...
  "module": "() => import('@/routes/furaffinity/submission-comments.ts')",
