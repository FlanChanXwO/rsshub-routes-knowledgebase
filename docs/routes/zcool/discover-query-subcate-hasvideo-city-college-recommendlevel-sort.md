...
- Namespace: `zcool`
- Namespace Name: `站酷`
- Route Path: `/discover/:query?/:subCate?/:hasVideo?/:city?/:college?/:recommendLevel?/:sort?`
- Route Name: `发现`
...
- Source Module: `() => import('@/routes/zcool/discover.ts')`
...
```json
{
  ...
  "module": "() => import('@/routes/zcool/discover.ts')",
  "name": "发现",
  "parameters": {
    "city": "地区代码，填入发现页中 `选择城市` 中的各级地名，如 `亚洲`、`中国`、`北京`、`纽约`、`巴黎`等",
    "college": "学校，默认为 `0` 即全部",
