  ...
  "topFeeds": [
    {
      ...
      "errorAt": "2026-07-15T05:19:02.475Z",
      "errorMessage": "[GET] \"https://apps.apple.com/api/apps/v1/catalog/cn/apps/414478124?platform=iphone&additionalPlatforms=appletv,ipad,iphone,mac,realityDevice,watch&extend=accessibility,accessibilityDetails,ageRating,backgroundAssetsInfo,backgroundAssetsInfoWithOptional,customArtwork,customDeepLink,customIconArtwork,customPromotionalText,customScreenshotsByType,customVideoPreviewsByType,description,expectedReleaseDateDisplayFormat,fileSizeByDevice,gameDisplayName,iconArtwork,installSizeByDeviceInBytes,macRequiredCapabilities,medicalDeviceInfo,messagesScreenshots,miniGamesDeepLink,minimumOSVersion,privacy,privacyDetails,privacyPolicyUrl,remoteControllerRequirement,requirementsByDeviceFamily,supportURLForLanguage,supportedGameCenterFeatures,supportsFunCamera,supportsSharePlay,versionHistory,websiteUrl&extend%5Bapps%5D=distributionKind,isVerifiedForAppleSiliconMac&extend%5Bapp-events%5D=description,productArtwork,productVideo&include=alternate-apps,app-bundles,customers-also-bought-apps,developer,developer-other-apps,merchandised-in-apps,related-editorial-items,reviews&include%5Bapps%5D=app-events&views=top-in-app-purchasables&availableIn%5Bapp-events%5D=future&sparseLimit%5Bapps:customers-also-bought-apps%5D=40&sparseLimit%5Bapps:developer-other-apps%5D=40&sparseLimit%5Bapps:related-editorial-items%5D=40&limit%5Breviews%5D=8&l=en-US\": <no response> Number of requests reached it's maximum 4800\nFailed to fetch\n",
