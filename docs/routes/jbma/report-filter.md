# Japan Bullion Market Association - Precious Metals Report
...
## Route
- Namespace: `jbma`
- Namespace Name: `Japan Bullion Market Association`
- Route Path: `/report/:filter{.+}?`
- Route Name: `Precious Metals Report`
- Example: `/jbma/report`
- URL: `jbma.net`
- Language: `ja`
...
- Source Module: `() => import('@/routes/jbma/report.ts')`
...
```json
{
  ...
  "module": "() => import('@/routes/jbma/report.ts')",
