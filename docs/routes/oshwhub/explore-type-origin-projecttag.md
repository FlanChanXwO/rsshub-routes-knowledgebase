...
## Route
- Namespace: `oshwhub`
- Namespace Name: `oshwhub 立创开源硬件平台`
- Route Path: `/explore/:type?/:origin?/:projectTag{.+}?`
- Route Name: `开源广场`
...
- Source Module: `() => import('@/routes/oshwhub/explore.ts')`
...
```json
{
  ...
  "module": "() => import('@/routes/oshwhub/explore.ts')",
  "name": "开源广场",
  "parameters": {
    "origin": {
