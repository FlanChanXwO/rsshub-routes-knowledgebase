...
- Route Path: `/samr/xgzlyhd/:category?/:department?`
- Route Name: `留言咨询`
...
- Maintainers: `nczitzk`
- Source Location: `samr/xgzlyhd.tsx`
- Source Module: `() => import('@/routes/gov/samr/xgzlyhd.tsx')`
...
```json
{
  ...
  "module": "() => import('@/routes/gov/samr/xgzlyhd.tsx')",
  "name": "留言咨询",
  "parameters": {
    "category": "留言类型，见下表，默认为全部",
    "department": "回复部门，见下表，默认为全部"
