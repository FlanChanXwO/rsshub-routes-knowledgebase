...
## Route
- Namespace: `wdfxw`
- Namespace Name: `WDFXW文档分享网`
- Route Path: `/bookfree/:id?`
- Route Name: `免费区`
...
- Categories: `reading`
- Maintainers: `nczitzk`
- Source Location: `bookfree.tsx`
- Source Module: `() => import('@/routes/wdfxw/bookfree.tsx')`
...
```json
{
  ...
  "module": "() => import('@/routes/wdfxw/bookfree.tsx')",
  "name": "免费区",
  "parameters": {
    "category": {
