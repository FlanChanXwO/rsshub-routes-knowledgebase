  ...
  "topFeeds": [
    {
      ...
      "errorMessage": "[GET] \"https://install.appcenter.ms/api/v0.1/apps/cloudflare/1.1.1.1-windows/distribution_groups/beta/public_releases?scope=tester\": 403 Forbidden\n",
